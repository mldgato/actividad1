    ...
    <div class="col">
        <div class="card border-info mt-3">
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <h2 class="text-info">Crear nueva nivel académico <i class="fa-solid fa-graduation-cap"></i></h2>
                    </div>
            ...
            <div class="card-body">
                <form action="<?php echo base_url('niveles/store'); ?>" method="post" name="formStore" id="formStore" accept-charset="utf-8" autocomplete="off">
                    <div class="row">
                        <div class="col">
